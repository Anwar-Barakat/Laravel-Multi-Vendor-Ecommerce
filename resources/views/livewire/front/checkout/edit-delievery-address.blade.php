            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="reg-wrapper wide item p-4">
                        <h2 class="account-h1">Edit Delivery Address</h2>
                        <form>
                            <div class="row mt-4">
                                ...
                                <div class="form-group col-lg-6 col-md-12">
                                    ...
                                    <input id="email" class="text-field mt-1 w-full" type="email" disabled value="{{ Auth::user()->email }}" />
                                </div>
                            </div>
                            <div class="row mt-4">
                            ...
                            <div class="flex items-center justify-end mt-4">
                                <button class="ml-4 button button-outline-secondary" wire:click.prevent="updateDeliveryAddress">
