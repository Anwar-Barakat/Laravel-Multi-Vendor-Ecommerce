        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="zoom-area">
                    ...
                    @else
                        <img id="zoom-pro" class="img-fluid" src="{{ asset('front/images/product/product@4x.jpg') }}"
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade active show" id="description">
                            <div class="description-whole-container">
                                <p class="desc-p u-s-m-b-26">Lorem ipsum dolor sit amet, consectetur adipiscing
