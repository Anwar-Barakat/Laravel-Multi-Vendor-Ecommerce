        ...
        <div class="main-header-right flex align-center">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto flex align-center">
                ...
                <div class="dropdown nav-item main-header-message ">
                    <a class="new nav-link d-flex align-items-center" href="#"><svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail">
                ...
                <div class="nav-item full-screen fullscreen-button">
                    <a class="new nav-link full-screen-link d-flex align-items-center" href="#"><svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-maximize">
