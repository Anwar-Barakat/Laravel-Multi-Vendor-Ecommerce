            ...
            <div class="dropdown user-pro-body">
                <div class="">
                    @if (Auth::guard('admin')->user()->getFirstMediaUrl('avatars', 'thumb'))
                        <img src="{{ Auth::guard('admin')->user()->getFirstMediaUrl('avatars', 'thumb') }}" class="avatar avatar-xl brround">
                    @else
                ...
                <div class="user-info">
                    ...
                    <span class="mb-0 text-muted">{{ strtoupper(str_replace('-', ' ', Auth::guard('admin')->user()->type)) }}</span>
                </div>
            </div>
        </div>
        <ul class="side-menu">
            ...
            @else
                ...
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="javascript:;">
                        <i class="fas fa-flag-checkered side-menu__icon"></i>
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'icons')) }}">
                    ...
                    <span class="side-menu__label">Icons</span><span class="badge badge-danger side-badge">New</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                    ...
                    </svg><span class="side-menu__label">Charts</span><i class="angle fas fa-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                    ...
                    </svg><span class="side-menu__label">Ecommerce</span><i class="angle fas fa-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                    ...
                    </svg><span class="side-menu__label">Apps</span><i class="angle fas fa-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                    ...
                    </svg><span class="side-menu__label">Elements</span><i class="angle fas fa-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        ...
                        <path d="M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8c.28 0 .5-.22.5-.5 0-.16-.08-.28-.14-.35-.41-.46-.63-1.05-.63-1.65 0-1.38 1.12-2.5 2.5-2.5H16c2.21 0 4-1.79 4-4 0-3.86-3.59-7-8-7zm-5.5 9c-.83 0-1.5-.67-1.5-1.5S5.67 10 6.5 10s1.5.67 1.5 1.5S7.33 13 6.5 13zm3-4C8.67 9 8 8.33 8 7.5S8.67 6 9.5 6s1.5.67 1.5 1.5S10.33 9 9.5 9zm5 0c-.83 0-1.5-.67-1.5-1.5S13.67 6 14.5 6s1.5.67 1.5 1.5S15.33 9 14.5 9zm4.5 2.5c0 .83-.67 1.5-1.5 1.5s-1.5-.67-1.5-1.5.67-1.5 1.5-1.5 1.5.67 1.5 1.5z"
                            opacity=".3" />
                    ...
                    </svg><span class="side-menu__label">Advanced UI</span><i class="angle fas fa-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                    ...
                    </svg><span class="side-menu__label">Mail</span><i class="angle fas fa-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                    ...
                    </svg><span class="side-menu__label">Forms</span><i class="angle fas fa-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                    ...
                    </svg><span class="side-menu__label">Tables</span><i class="angle fas fa-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" href="{{ url('/' . ($page = 'widgets')) }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                    ...
                    </svg><span class="side-menu__label">Widgets</span><span class="badge badge-warning side-badge">Hot</span></a>
            </li>
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                        <path d="M0 0h24v24H0V0z" fill="none" />
                    ...
                    </svg><span class="side-menu__label">Maps</span><i class="angle fas fa-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" class="side-menu__icon" viewBox="0 0 24 24">
                    ...
                    </svg><span class="side-menu__label">Pages</span><i class="angle fas fa-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                    ...
                    </svg><span class="side-menu__label">Utilities</span><i class="angle fas fa-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                    ...
                    </svg><span class="side-menu__label">Custom Pages</span><i class="angle fas fa-chevron-down"></i></a>
                <ul class="slide-menu">
            ...
            <li class="slide ">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                    ...
                    </svg><span class="side-menu__label">Submenus</span><i class="angle fas fa-chevron-down"></i></a>
                <ul class="slide-menu">
                    <li class="sub-slide">
                        <a class="sub-side-menu__item" data-toggle="sub-slide" href="{{ url('/' . ($page = '#')) }}"><span class="sub-side-menu__label">Level1</span><i class="sub-angle fas fa-chevron-down"></i></a>
